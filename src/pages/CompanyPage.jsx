      ...
      <div className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4 text-white">Explore Darvin</h2>
            ...
            {childPages.map((page, index) => {
              ...
              return (
                <Link key={index} to={page.link} className="group">
                  <div className="bg-slate-800/30 rounded-2xl p-8 border border-slate-700/50 hover:border-slate-600/50 transition-all h-full hover:transform hover:scale-105">
            ...
            <div className="relative">
              <div className="w-full h-80 bg-gradient-to-br from-blue-600/20 to-purple-600/20 rounded-2xl border border-blue-500/30 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-blue-300 text-lg font-medium">Building the Future of Security</p>
                </div>
              </div>
            </div>
          </div>
